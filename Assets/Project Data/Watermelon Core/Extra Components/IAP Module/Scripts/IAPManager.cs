...
namespace TitleGame
{
   // [HelpURL("https://docs.google.com/document/d/1GlS55aF4z4Ddn4a1QCu5h0152PoOb29Iy4y9RKZ9Y9Y")]
    public static class IAPManager
    {
        ...
        public static void OnPurchaseFailed(ProductKeyType productKey, TitleGame.PurchaseFailureReason failureReason)
        {
            OnPurchaseFailded?.Invoke(productKey, failureReason);
        }

        public delegate void ProductCallback(ProductKeyType productKeyType);
        public delegate void ProductFailCallback(ProductKeyType productKeyType, TitleGame.PurchaseFailureReason failureReason);
    }

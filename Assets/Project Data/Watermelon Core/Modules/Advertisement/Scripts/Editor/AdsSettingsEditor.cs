    ...
    public class AdsSettingsEditor : Editor
    {
        ...
        private class AdMobContainer : AdsContainer
        {
            ...
            private void DrawAddUnitsSection()
            {
                ...
                DrawIdProperty(androidBannerIdProperty, TitleGame.AdMobContainer.ANDROID_BANNER_TEST_ID);
                DrawIdProperty(iOSBannerIdProperty, TitleGame.AdMobContainer.IOS_BANNER_TEST_ID);

                EditorGUILayout.PropertyField(bannerTypeProperty);
                EditorGUILayout.PropertyField(bannerPositionProperty);

                EditorGUILayout.LabelField("Interstitial ID", groupStyle);
                DrawIdProperty(androidInterstitialIdProperty, TitleGame.AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID);
                DrawIdProperty(iOSInterstitialIdProperty, TitleGame.AdMobContainer.IOS_INTERSTITIAL_TEST_ID);

                EditorGUILayout.LabelField("Rewarded Video ID", groupStyle);
                DrawIdProperty(androidRewardedVideoIdProperty, TitleGame.AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID);
                DrawIdProperty(iOSRewardedVideoIdProperty, TitleGame.AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID);
                ...
                {
                    androidBannerIdProperty.stringValue = TitleGame.AdMobContainer.ANDROID_BANNER_TEST_ID;
                    iOSBannerIdProperty.stringValue = TitleGame.AdMobContainer.IOS_BANNER_TEST_ID;
                    androidInterstitialIdProperty.stringValue = TitleGame.AdMobContainer.ANDROID_INTERSTITIAL_TEST_ID;
                    iOSInterstitialIdProperty.stringValue = TitleGame.AdMobContainer.IOS_INTERSTITIAL_TEST_ID;
                    androidRewardedVideoIdProperty.stringValue = TitleGame.AdMobContainer.ANDROID_REWARDED_VIDEO_TEST_ID;
                    iOSRewardedVideoIdProperty.stringValue = TitleGame.AdMobContainer.IOS_REWARDED_VIDEO_TEST_ID;
                }
            }

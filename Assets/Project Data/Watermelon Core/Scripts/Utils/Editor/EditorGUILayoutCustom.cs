...
namespace TitleGame
{
    public static class EditorGUILayoutCustom
    {
        ...
        {
            Rect headerRect = EditorGUILayout.BeginHorizontal(GUILayout.Height(HEADER_HEIGHT), GUILayout.ExpandWidth(true));
            ...
            value = EditorGUILayout.Toggle(value, WatermelonEditor.Styles.Skin.toggle, GUILayout.Width(32f), GUILayout.Height(16f));
        ...
        {
            EditorGUILayout.BeginHorizontal(GUILayout.Height(HEADER_HEIGHT), GUILayout.ExpandWidth(true));
        ...
        {
            Rect rect = EditorGUILayout.BeginHorizontal(GUILayout.Height(HEADER_HEIGHT), GUILayout.ExpandWidth(true));

            EditorGUILayout.LabelField(title, WatermelonEditor.Styles.boxHeader, GUILayout.ExpandHeight(true), GUILayout.ExpandWidth(true));

            EditorGUILayout.LabelField(expandValue ? activeContent : disableContent, GUILayout.Width(14), GUILayout.Height(HEADER_HEIGHT));
        ...
        public static bool HeaderButton(string title, GUIContent buttonContent, GUIStyle buttonStyle, bool disableState, params GUILayoutOption[] options)
        {
